        ...
        <aside className="lg:w-1/3 space-y-4 print:hidden">
            ...
            {isBulkMode && (
                <div className="bg-amber-50 border border-amber-200 p-4 rounded-2xl shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-bold text-amber-800">Bulk Settings (Quantity):</h3>
                        <input
            ...
            <div className="bg-white/90 backdrop-blur-xl p-5 rounded-2xl shadow-lg border border-white/50 relative overflow-hidden">
                ...
                <div className="space-y-3 relative z-10">
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><GraduationCap size={12} /> Exam Type</label>
                            <select
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><CalendarIcon size={12} /> Date</label>
                            <input
                                type="date"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Hash size={12} /> Semester</label>
                            <select
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Grid size={12} /> Section</label>
                            <select
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Clock size={12} /> Total Time</label>
                            <input
                                type="text"
                        ...
                        {activePaper.examMeta.examType !== 'Assignment' && (
                            <div>
                                <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Timer size={12} /> MCQs Duration</label>
                                <input
                                    type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><BookOpen size={12} /> Subject Title</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Target size={12} /> Subject Code</label>
                            <input
                                type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Building2 size={12} /> Department</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><User size={12} /> Instructor</label>
                            <input
                                type="text"
            ...
            <div className="bg-white/90 backdrop-blur-xl p-5 rounded-2xl shadow-lg border border-white/50 relative overflow-hidden">
                <h2 className="text-lg font-bold mb-4 flex items-center gap-2 text-indigo-700 relative z-10">
                    ...
                    {activePaper.examMeta.examType === 'Assignment' ? 'Assignment Pattern' : activePaper.examMeta.examType === 'Quiz' ? 'Quiz Pattern' : 'Paper Pattern'}
                </h2>
                <div className="space-y-4 relative z-10">
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><Globe size={12} /> Language</label>
                        ...
                        <div>
                            <label className="block text-xs font-bold text-slate-500 mb-1 flex items-center gap-1"><BrainCircuit size={12} /> Style</label>
                    ...
                    <div className="bg-indigo-50/40 p-3 rounded-xl border border-indigo-100/50">
                        <label className="block text-xs font-bold text-indigo-500 mb-2 text-center">Number of Questions & Marks</label>
                        <div className="grid grid-cols-3 gap-2">
                            {/* MCQs: Hide for Assignment */}
                            {activePaper.examMeta.examType !== 'Assignment' && (
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="block text-[10px] font-medium text-slate-600 text-center">Short (Qty)</label>
                            ...
                            {/* Long: Hide for Quiz */}
                            {activePaper.examMeta.examType !== 'Quiz' && (
                                <div className="flex flex-col gap-1">
                                    <label className="block text-[10px] font-medium text-slate-600 text-center">Long (Qty)</label>
                        ...
                        <div className="text-[10px] text-center text-slate-400 mt-1">* Enter marks per question in small boxes</div>
                    </div>
                </div>
            </div>
                ...
                {activePaper.inputMode === 'Content' ? (
                    <>
                        <div className="mb-3 relative z-10">
                            ...
                            {!activePaper.fileData ? (
                                <label htmlFor="file-upload" className="flex flex-col items-center justify-center w-full h-20 border-2 border-dashed border-indigo-200 rounded-xl cursor-pointer bg-indigo-50/30 hover:bg-indigo-50 hover:border-indigo-400 transition-all">
                                    ...
                                    <span className="text-[10px] text-indigo-700 font-bold">Upload PDF File</span>
                                </label>
                            ) : (
                        ...
                        <textarea
                            ...
                            placeholder={activePaper.fileData ? "File uploaded successfully." : "Paste your notes or content here..."}
                        ></textarea>
                    </>
                ) : (
                    <div className="flex-grow flex flex-col z-10">
                        <label className="text-xs font-bold text-purple-700 mb-2">Topic:</label>
                        <textarea
                            ...
                            placeholder="Enter your topics or outline here..."
                        ></textarea>
                    </div>
                )}
